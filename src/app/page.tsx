    ...
    <div className="flex flex-col items-center w-full bg-zinc-50 overflow-hidden relative selection:bg-orange-500/30">
      ...
      <section className="w-full py-40 bg-white text-center border-t border-zinc-200">
        <div className="container px-4 max-w-4xl mx-auto space-y-12">
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-tighter text-zinc-900">
            Scale your <span className="text-orange-500">empire.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
            ...
            <Link href="/pricing">
              <Button variant="ghost" size="lg" className="h-16 px-8 text-xl font-bold text-zinc-600 hover:text-zinc-900 rounded-full group">
